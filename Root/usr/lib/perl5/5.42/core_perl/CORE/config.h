...
/* Package name      : perl5
 * Source directory  : .
 * Configuration time: Thu Apr  2 07:19:33 UTC 2026
 ...
 */
#define ARCHLIB "/usr/lib/perl5/5.42/core_perl"		/**/
#define ARCHLIB_EXP "/usr/lib/perl5/5.42/core_perl"		/**/
 ...
 *	in programs that are not prepared to deal with ~ expansion at run-time.
 */
#define SITEARCH "/usr/lib/perl5/5.42/site_perl"		/**/
#define SITEARCH_EXP "/usr/lib/perl5/5.42/site_perl"		/**/
 ...
 *	in programs that are not prepared to deal with ~ expansion at run-time.
 */
#define PERL_VENDORARCH "/usr/lib/perl5/5.42/vendor_perl"		/**/
#define PERL_VENDORARCH_EXP "/usr/lib/perl5/5.42/vendor_perl"		/**/
